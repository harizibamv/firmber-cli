import { EditMode } from "../../types/tools.js";



export function generatePostEditContext(lines: string[], editStartLine:number, editEndLine:number, mode: EditMode):string {
...
export function calculateActualEditRange(mode:EditMode,lineNum: number, endLineArg:number| undefined, content: string, targetLine?:number,):{
